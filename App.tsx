  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-200 selection:bg-indigo-500/30 selection:text-indigo-200 font-sans">
      ...
      <main>
        ...
        {/* Projects Section */}
        <section id={SectionId.PROJECTS} className="py-24 bg-neutral-950 min-h-screen">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
              <div>
                <span className="text-sm font-mono text-indigo-400 block mb-2">● Lab</span>
                <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">The Playground</h2>
              </div>
